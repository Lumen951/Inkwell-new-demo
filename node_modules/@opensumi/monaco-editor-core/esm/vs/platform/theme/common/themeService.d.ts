...
export declare const IThemeService: import("../../instantiation/common/instantiation").ServiceIdentifier<IThemeService>;
export declare function themeColorFromId(id: ColorIdentifier): {
    id: string;
};
export declare const FileThemeIcon: import("../../../base/common/themables").ThemeIcon;
export declare const FolderThemeIcon: import("../../../base/common/themables").ThemeIcon;
