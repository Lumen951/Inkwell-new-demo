        ...
        this.iconSchema = {
            definitions: {
                icons: {
                    type: 'object',
                    properties: {
                        fontId: { type: 'string', description: (0, nls_1.localize)("vs/platform/theme/common/iconRegistry",0, 'The id of the font to use. If not set, the font that is defined first is used.') },
                        fontCharacter: { type: 'string', description: (0, nls_1.localize)("vs/platform/theme/common/iconRegistry",1, 'The font character associated with the icon definition.') }
                    },
...
// common icons
exports.widgetClose = registerIcon('widget-close', codicons_1.Codicon.close, (0, nls_1.localize)("vs/platform/theme/common/iconRegistry",2, 'Icon for the close action in widgets.'));
exports.gotoPreviousLocation = registerIcon('goto-previous-location', codicons_1.Codicon.arrowUp, (0, nls_1.localize)("vs/platform/theme/common/iconRegistry",3, 'Icon for goto previous editor location.'));
exports.gotoNextLocation = registerIcon('goto-next-location', codicons_1.Codicon.arrowDown, (0, nls_1.localize)("vs/platform/theme/common/iconRegistry",4, 'Icon for goto next editor location.'));
