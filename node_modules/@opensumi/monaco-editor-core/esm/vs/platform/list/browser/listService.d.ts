...
import { IListAccessibilityProvider, IListOptions, IListOptionsUpdate, IListStyles, List } from '../../../base/browser/ui/list/listWidget';
...
import { IContextKey, IContextKeyService, IScopedContextKeyService, RawContextKey } from '../../contextkey/common/contextkey';
import { IEditorOptions } from '../../editor/common/editor';
import { IInstantiationService } from '../../instantiation/common/instantiation';
import { IStyleOverride } from '../../theme/browser/defaultStyles';
...
export declare const WorkbenchListScrollAtTopContextKey: import("../../contextkey/common/contextkey").ContextKeyExpression | undefined;
export declare const WorkbenchListScrollAtBottomContextKey: import("../../contextkey/common/contextkey").ContextKeyExpression | undefined;
