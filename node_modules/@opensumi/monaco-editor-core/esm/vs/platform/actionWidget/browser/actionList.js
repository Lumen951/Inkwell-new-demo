...
let ActionItemRenderer = class ActionItemRenderer {
    ...
    renderElement(element, _index, data) {
        ...
        const actionTitle = (_b = this._keybindingService.lookupKeybinding(exports.acceptSelectedActionCommand)) === null || _b === void 0 ? void 0 : _b.getLabel();
        const previewTitle = (_c = this._keybindingService.lookupKeybinding(exports.previewSelectedActionCommand)) === null || _c === void 0 ? void 0 : _c.getLabel();
        ...
        if (element.disabled) {
            ...
            if (this._supportsPreview && element.canPreview) {
                data.container.title = (0, nls_1.localize)("vs/platform/actionWidget/browser/actionList",0, "{0} to apply, {1} to preview", actionTitle, previewTitle);
            }
            else {
                data.container.title = (0, nls_1.localize)("vs/platform/actionWidget/browser/actionList",1, "{0} to apply", actionTitle);
            }
        }
        else {
            ...
            accessibilityProvider: {
                getAriaLabel: element => {
                    if (element.kind === "action" /* ActionListItemKind.Action */) {
                        ...
                        if (element.disabled) {
                            label = (0, nls_1.localize)("vs/platform/actionWidget/browser/actionList",2, "{0}, Disabled Reason: {1}", label, element.disabled);
                        }
                        return label;
                    }
                    return null;
                },
                getWidgetAriaLabel: () => (0, nls_1.localize)("vs/platform/actionWidget/browser/actionList",3, "Action Widget"),
