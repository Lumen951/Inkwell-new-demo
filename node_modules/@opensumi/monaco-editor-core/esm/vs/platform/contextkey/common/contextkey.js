...
const errorEmptyString = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",0, "Empty context key expression");
const hintEmptyString = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",1, "Did you forget to write an expression? You can also put 'false' or 'true' to always evaluate to false or true, respectively.");
const errorNoInAfterNot = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",2, "'in' after 'not'.");
const errorClosingParenthesis = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",3, "closing parenthesis ')'");
const errorUnexpectedToken = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",4, "Unexpected token");
const hintUnexpectedToken = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",5, "Did you forget to put && or || before the token?");
const errorUnexpectedEOF = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",6, "Unexpected end of expression");
const hintUnexpectedEOF = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",7, "Did you forget to put a context key?");
/**
...
class Parser {
    ...
    _errExpectedButGot(expected, got, additionalInfo) {
        const message = (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",8, "Expected: {0}\nReceived: '{1}'.", expected, scanner_1.Scanner.getLexeme(got));
        ...
        if (parser.lexingErrors.length > 0) {
            return parser.lexingErrors.map((se) => ({
                errorMessage: se.additionalInfo ?
                    (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",9, "Unexpected token. Hint: {0}", se.additionalInfo) :
                    (0, nls_1.localize)("vs/platform/contextkey/common/contextkey",10, "Unexpected token."),
                offset: se.offset,
