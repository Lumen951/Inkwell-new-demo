...
const ternarySearchTree_1 = require("../../../base/common/ternarySearchTree");
...
exports.WORKSPACE_FILTER = [{ name: (0, nls_1.localize)("vs/platform/workspace/common/workspace",0, "Code Workspace"), extensions: [exports.WORKSPACE_EXTENSION] }];
