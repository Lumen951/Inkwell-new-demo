    ...
    updateKeyTarget(key, scope, target, external = false) {
        ...
        if (typeof target === 'number') {
            if (keyTargets[key] !== target) {
                ...
                (_a = this.getStorage(scope)) === null || _a === void 0 ? void 0 : _a.set(exports.TARGET_KEY, JSON.stringify(keyTargets), external);
            }
        }
        // Remove
        else {
            if (typeof keyTargets[key] === 'number') {
                ...
                (_b = this.getStorage(scope)) === null || _b === void 0 ? void 0 : _b.set(exports.TARGET_KEY, JSON.stringify(keyTargets), external);
            }
        }
    }
