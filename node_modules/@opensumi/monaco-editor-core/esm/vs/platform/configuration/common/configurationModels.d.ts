...
import { ConfigurationTarget, IConfigurationChange, IConfigurationChangeEvent, IConfigurationData, IConfigurationModel, IConfigurationOverrides, IConfigurationUpdateOverrides, IConfigurationValue, IInspectValue, IOverrides } from './configuration';
...
export declare class ConfigurationModel implements IConfigurationModel {
    ...
    readonly raw?: readonly (ConfigurationModel | IStringDictionary<any>)[] | undefined;
    private readonly overrideConfigurations;
    constructor(_contents?: any, _keys?: string[], _overrides?: IOverrides[], raw?: readonly (ConfigurationModel | IStringDictionary<any>)[] | undefined);
...
export declare class UserSettings extends Disposable {
    ...
    constructor(userSettingsResource: URI, parseOptions: ConfigurationParseOptions, extUri: IExtUri, fileService: IFileService);
