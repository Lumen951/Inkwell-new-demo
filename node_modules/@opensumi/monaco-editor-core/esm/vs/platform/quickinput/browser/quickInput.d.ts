...
declare class QuickInput extends Disposable implements IQuickInput {
...
export declare class QuickPick<T extends IQuickPickItem> extends QuickInput implements IQuickPick<T> {
    ...
    onDidCustom: Event<void>;
    get items(): Array<T | IQuickPickSeparator>;
