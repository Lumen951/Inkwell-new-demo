...
exports.backButton = {
    ...
    tooltip: (0, nls_1.localize)("vs/platform/quickinput/browser/quickInput",0, "Back"),
    handle: -1 // TODO
};
class QuickInput extends lifecycle_1.Disposable {
    ...
    update() {
        ...
        if (this.togglesUpdated) {
            ...
            const concreteToggles = (_b = (_a = this.toggles) === null || _a === void 0 ? void 0 : _a.filter(opts => opts instanceof toggle_1.Toggle)) !== null && _b !== void 0 ? _b : [];
    ...
    getSteps() {
        if (this.step && this.totalSteps) {
            return (0, nls_1.localize)("vs/platform/quickinput/browser/quickInput",2, "{0}/{1}", this.step, this.totalSteps);
        }
        if (this.step) {
...
QuickInput.noPromptMessage = (0, nls_1.localize)("vs/platform/quickinput/browser/quickInput",1, "Press 'Enter' to confirm your input or 'Escape' to cancel");
...
QuickPick.DEFAULT_ARIA_LABEL = (0, nls_1.localize)("vs/platform/quickinput/browser/quickInput",3, "Type to narrow down results.");
class InputBox extends QuickInput {
    ...
    set prompt(prompt) {
        ...
        this.noValidationMessage = prompt
            ? (0, nls_1.localize)("vs/platform/quickinput/browser/quickInput",4, "{0} (Press 'Enter' to confirm or 'Escape' to cancel)", prompt)
