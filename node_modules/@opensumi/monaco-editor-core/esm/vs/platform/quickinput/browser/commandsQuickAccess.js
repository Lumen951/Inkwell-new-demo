...
const tfIdf_1 = require("../../../base/common/tfIdf");
...
let AbstractCommandsQuickAccessProvider = AbstractCommandsQuickAccessProvider_1 = class AbstractCommandsQuickAccessProvider extends pickerQuickAccess_1.PickerQuickAccessProvider {
    ...
    async _getPicks(filter, _disposables, token, runOptions) {
        ...
        for (let i = 0; i < filteredCommandPicks.length; i++) {
            ...
            if (i === 0 && this.commandsHistory.peek(commandPick.commandId)) {
                commandPicks.push({ type: 'separator', label: (0, nls_1.localize)("vs/platform/quickinput/browser/commandsQuickAccess",0, "recently used") });
                addOtherSeparator = true;
            }
            if (addSuggestedSeparator && commandPick.tfIdfScore !== undefined) {
                commandPicks.push({ type: 'separator', label: (0, nls_1.localize)("vs/platform/quickinput/browser/commandsQuickAccess",1, "similar commands") });
            ...
            if (addCommonlyUsedSeparator && commandPick.tfIdfScore === undefined && !this.commandsHistory.peek(commandPick.commandId) && ((_c = this.options.suggestedCommandIds) === null || _c === void 0 ? void 0 : _c.has(commandPick.commandId))) {
                commandPicks.push({ type: 'separator', label: (0, nls_1.localize)("vs/platform/quickinput/browser/commandsQuickAccess",2, "commonly used") });
                addOtherSeparator = true;
            ...
            if (addOtherSeparator && commandPick.tfIdfScore === undefined && !this.commandsHistory.peek(commandPick.commandId) && !((_d = this.options.suggestedCommandIds) === null || _d === void 0 ? void 0 : _d.has(commandPick.commandId))) {
                commandPicks.push({ type: 'separator', label: (0, nls_1.localize)("vs/platform/quickinput/browser/commandsQuickAccess",3, "other commands") });
        ...
        return {
            ...
            additionalPicks: (async () => {
                ...
                if (addSuggestedSeparator && ((_a = commandPicks[0]) === null || _a === void 0 ? void 0 : _a.type) !== 'separator') {
                    commandPicks.unshift({ type: 'separator', label: (0, nls_1.localize)("vs/platform/quickinput/browser/commandsQuickAccess",4, "similar commands") });
                }
                return commandPicks;
            })()
        };
    ...
    toCommandPick(commandPick, runOptions) {
        ...
        const ariaLabel = keybinding ?
            (0, nls_1.localize)("vs/platform/quickinput/browser/commandsQuickAccess",5, "{0}, {1}", commandPick.label, keybinding.getAriaLabel()) :
            commandPick.label;
        return {
            ...commandPick,
            ariaLabel,
            ...
            accept: async () => {
                ...
                try {
                    ...
                    if (!(0, errors_1.isCancellationError)(error)) {
                        this.dialogService.error((0, nls_1.localize)("vs/platform/quickinput/browser/commandsQuickAccess",6, "Command '{0}' resulted in an error", commandPick.label), (0, errorMessage_1.toErrorMessage)(error));
                    }
                }
            }
        };
...
let CommandsHistory = CommandsHistory_1 = class CommandsHistory extends lifecycle_1.Disposable {
