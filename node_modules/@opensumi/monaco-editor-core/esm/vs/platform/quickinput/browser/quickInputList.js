...
const theme_1 = require("../../theme/common/theme");
const $ = dom.$;
class ListElement {
...
class ListElementRenderer {
    ...
    renderElement(element, index, data) {
        ...
        if ((_b = element.item) === null || _b === void 0 ? void 0 : _b.iconPath) {
            const icon = (0, theme_1.isDark)(this.themeService.getColorTheme().type) ? element.item.iconPath.dark : ((_c = element.item.iconPath.light) !== null && _c !== void 0 ? _c : element.item.iconPath.dark);
        ...
        // Filter by value (since we support icons in labels, use $(..) aware fuzzy matching)
            ...
            this.elements.forEach(element => {
                ...
                if (this.matchOnLabelMode === 'fuzzy') {
                    labelHighlights = this.matchOnLabel ? (_a = (0, iconLabels_1.matchesFuzzyIconAware)(query, (0, iconLabels_1.parseLabelWithIcons)(element.saneLabel))) !== null && _a !== void 0 ? _a : undefined : undefined;
                }
                else {
                    labelHighlights = this.matchOnLabel ? (_b = matchesContiguousIconAware(queryWithWhitespace, (0, iconLabels_1.parseLabelWithIcons)(element.saneLabel))) !== null && _b !== void 0 ? _b : undefined : undefined;
                }
                const descriptionHighlights = this.matchOnDescription ? (_c = (0, iconLabels_1.matchesFuzzyIconAware)(query, (0, iconLabels_1.parseLabelWithIcons)(element.saneDescription || ''))) !== null && _c !== void 0 ? _c : undefined : undefined;
                const detailHighlights = this.matchOnDetail ? (_d = (0, iconLabels_1.matchesFuzzyIconAware)(query, (0, iconLabels_1.parseLabelWithIcons)(element.saneDetail || ''))) !== null && _d !== void 0 ? _d : undefined : undefined;
...
class QuickInputAccessibilityProvider {
    getWidgetAriaLabel() {
        return (0, nls_1.localize)("vs/platform/quickinput/browser/quickInputList",0, "Quick Input");
    }
