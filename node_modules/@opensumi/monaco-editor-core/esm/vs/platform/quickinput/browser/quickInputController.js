...
const progressbar_1 = require("../../../base/browser/ui/progressbar/progressbar");
...
const quickInput_2 = require("./quickInput");
...
class QuickInputController extends lifecycle_1.Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        checkAll.setAttribute('aria-label', (0, nls_1.localize)("vs/platform/quickinput/browser/quickInputController",0, "Toggle all checkboxes"));
        ...
        const visibleCount = new countBadge_1.CountBadge(visibleCountContainer, { countFormat: (0, nls_1.localize)("vs/platform/quickinput/browser/quickInputController",1, "{0} Results") }, this.styles.countBadge);
        const countContainer = dom.append(filterContainer, $('.quick-input-count'));
        countContainer.setAttribute('aria-live', 'polite');
        const count = new countBadge_1.CountBadge(countContainer, { countFormat: (0, nls_1.localize)("vs/platform/quickinput/browser/quickInputController",2, "{0} Selected") }, this.styles.countBadge);
        const okContainer = dom.append(headerContainer, $('.quick-input-action'));
        const ok = this._register(new button_1.Button(okContainer, this.styles.button));
        ok.label = (0, nls_1.localize)("vs/platform/quickinput/browser/quickInputController",3, "OK");
        ...
        customButton.label = (0, nls_1.localize)("vs/platform/quickinput/browser/quickInputController",4, "Custom");
    ...
    show(controller) {
        ...
        quickInput_2.backButton.tooltip = backKeybindingLabel ? (0, nls_1.localize)("vs/platform/quickinput/browser/quickInputController",5, "Back ({0})", backKeybindingLabel) : (0, nls_1.localize)("vs/platform/quickinput/browser/quickInputController",6, "Back");
