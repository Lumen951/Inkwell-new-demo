...
const diffEditorWidget_1 = require("../../browser/widget/diffEditor/diffEditorWidget");
...
const hoverDelegate_1 = require("../../../base/browser/ui/hover/hoverDelegate");
const hover_1 = require("../../../platform/hover/browser/hover");
...
let StandaloneCodeEditor = class StandaloneCodeEditor extends codeEditorWidget_1.CodeEditorWidget {
    constructor(domElement, _options, instantiationService, codeEditorService, commandService, contextKeyService, keybindingService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        (0, hoverDelegate_1.setHoverDelegateFactory)((placement, enableInstantHover) => instantiationService.createInstance(hover_1.WorkbenchHoverDelegate, placement, enableInstantHover, {}));
    }
