        ...
        if (this.editor.hasModel()) {
            ...
            this.editor.changeDecorations((accessor) => {
                ...
                this.decorationId = accessor.addDecoration(selection_1.Selection.fromPositions(position, position), {
                    ...
                    hoverMessage: new htmlContent_1.MarkdownString().appendText((0, nls_1.localize)("vs/editor/contrib/anchorSelect/browser/anchorSelect",0, "Selection Anchor")),
                    className: 'selection-anchor'
                });
            });
            this.selectionAnchorSetContextKey.set(!!this.decorationId);
            (0, aria_1.alert)((0, nls_1.localize)("vs/editor/contrib/anchorSelect/browser/anchorSelect",1, "Anchor set at {0}:{1}", position.lineNumber, position.column));
        }
    }
    goToSelectionAnchor() {
...
class SetSelectionAnchor extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: (0, nls_1.localize)("vs/editor/contrib/anchorSelect/browser/anchorSelect",2, "Set Selection Anchor"),
...
class GoToSelectionAnchor extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: (0, nls_1.localize)("vs/editor/contrib/anchorSelect/browser/anchorSelect",3, "Go to Selection Anchor"),
...
class SelectFromAnchorToCursor extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: (0, nls_1.localize)("vs/editor/contrib/anchorSelect/browser/anchorSelect",4, "Select from Anchor to Cursor"),
...
class CancelSelectionAnchor extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: (0, nls_1.localize)("vs/editor/contrib/anchorSelect/browser/anchorSelect",5, "Cancel Selection Anchor"),
