...
const inlineCompletionContextKeys_1 = require("../../inlineCompletions/browser/inlineCompletionContextKeys");
const snippetController2_1 = require("../../snippet/browser/snippetController2");
const environment_1 = require("../../../../platform/environment/common/environment");
class LineContext {
...
let SuggestModel = SuggestModel_1 = class SuggestModel {
    ...
    _doTriggerQuickSuggest() {
        ...
        if (this._editor.getOption(118 /* EditorOption.suggest */).snippetsPreventQuickSuggestions && ((_a = snippetController2_1.SnippetController2.get(this._editor)) === null || _a === void 0 ? void 0 : _a.isInSnippet())) {
    ...
    trigger(options) {
        ...
        const completionOptions = new suggest_1.CompletionOptions(snippetSortOrder, (_d = (_c = options.completionOptions) === null || _c === void 0 ? void 0 : _c.kindFilter) !== null && _d !== void 0 ? _d : itemKindFilter, (_e = options.completionOptions) === null || _e === void 0 ? void 0 : _e.providerFilter, (_f = options.completionOptions) === null || _f === void 0 ? void 0 : _f.providerItemsToReuse, showDeprecated);
