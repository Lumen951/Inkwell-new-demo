...
class StatusBarViewItem extends menuEntryActionViewItem_1.MenuEntryActionViewItem {
    updateLabel() {
        ...
        if (this.label) {
            this.label.textContent = (0, nls_1.localize)("vs/editor/contrib/suggest/browser/suggestWidgetStatus",0, '{0} ({1})', this._action.label, StatusBarViewItem.symbolPrintEnter(kb));
        }
    }
