...
class TriggerSuggestAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/suggest/browser/suggestController",1, "Trigger Suggest"),
...
(0, editorExtensions_1.registerEditorCommand)(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            menuId: suggest_1.suggestWidgetStatusbarMenu,
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",3, "Insert"),
            group: 'left',
            order: 1,
...
(0, editorExtensions_1.registerEditorCommand)(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            order: 2,
            when: contextkey_1.ContextKeyExpr.and(suggest_1.Context.HasInsertAndReplaceRange, suggest_1.Context.InsertMode.isEqualTo('insert')),
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",5, "Replace")
        }, {
            menuId: suggest_1.suggestWidgetStatusbarMenu,
            group: 'left',
            order: 2,
            when: contextkey_1.ContextKeyExpr.and(suggest_1.Context.HasInsertAndReplaceRange, suggest_1.Context.InsertMode.isEqualTo('replace')),
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",6, "Insert")
        }]
}));
...
(0, editorExtensions_1.registerEditorCommand)(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",7, "show less")
        }, {
            menuId: suggest_1.suggestWidgetStatusbarMenu,
            group: 'right',
            order: 1,
            when: contextkey_1.ContextKeyExpr.and(suggest_1.Context.DetailsVisible.toNegated(), suggest_1.Context.CanResolve),
            title: nls.localize("vs/editor/contrib/suggest/browser/suggestController",8, "show more")
        }]
}));
(0, editorExtensions_1.registerEditorCommand)(new SuggestCommand({
...
(0, editorExtensions_1.registerEditorAction)(class extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/suggest/browser/suggestController",9, "Reset Suggest Widget Size"),
