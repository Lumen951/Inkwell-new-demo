...
class CursorUndo extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            id: 'cursorUndo',
            label: nls.localize("vs/editor/contrib/cursorUndo/browser/cursorUndo",0, "Cursor Undo"),
            alias: 'Cursor Undo',
...
class CursorRedo extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            id: 'cursorRedo',
            label: nls.localize("vs/editor/contrib/cursorUndo/browser/cursorUndo",1, "Cursor Redo"),
            alias: 'Cursor Redo',
            precondition: undefined
        });
    }
