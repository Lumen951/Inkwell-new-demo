...
const lineCommentCommand_1 = require("./lineCommentCommand");
...
class ToggleCommentLineAction extends CommentLineAction {
    constructor() {
        super(0 /* Type.Toggle */, {
            ...
            label: nls.localize("vs/editor/contrib/comment/browser/comment",0, "Toggle Line Comment"),
            ...
            menuOpts: {
                ...
                group: '5_insert',
                title: nls.localize("vs/editor/contrib/comment/browser/comment",1, "&&Toggle Line Comment"),
                order: 1
            }
        });
    }
...
class AddLineCommentAction extends CommentLineAction {
    constructor() {
        super(1 /* Type.ForceAdd */, {
            ...
            label: nls.localize("vs/editor/contrib/comment/browser/comment",2, "Add Line Comment"),
...
class RemoveLineCommentAction extends CommentLineAction {
    constructor() {
        super(2 /* Type.ForceRemove */, {
            ...
            label: nls.localize("vs/editor/contrib/comment/browser/comment",3, "Remove Line Comment"),
...
class BlockCommentAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/comment/browser/comment",4, "Toggle Block Comment"),
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarEditMenu,
                group: '5_insert',
                title: nls.localize("vs/editor/contrib/comment/browser/comment",5, "Toggle &&Block Comment"),
                order: 2
            }
        });
    }
