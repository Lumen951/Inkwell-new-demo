...
const ctxCancellableOperation = new contextkey_1.RawContextKey('cancellableOperation', false, (0, nls_1.localize)("vs/editor/contrib/editorState/browser/keybindingCancellation",0, 'Whether the editor runs a cancellable operation, e.g. like \'Peek References\''));
