...
const markdownRenderer_2 = require("../../../browser/widget/markdownRenderer/browser/markdownRenderer");
...
MessageController.MESSAGE_VISIBLE = new contextkey_1.RawContextKey('messageVisible', false, nls.localize("vs/editor/contrib/message/browser/messageController",0, 'Whether the editor is currently showing an inline message'));
