...
const stickyScrollWidget_1 = require("./stickyScrollWidget");
const stickyScrollProvider_1 = require("./stickyScrollProvider");
...
const foldingModel_1 = require("../../folding/browser/foldingModel");
let StickyScrollController = StickyScrollController_1 = class StickyScrollController extends lifecycle_1.Disposable {
    ...
    async _renderStickyScroll(rebuildFromLine) {
        ...
        if (stickyLineVersion === undefined || stickyLineVersion === model.getVersionId()) {
            this._foldingModel = (_b = await ((_a = folding_1.FoldingController.get(this._editor)) === null || _a === void 0 ? void 0 : _a.getFoldingModel())) !== null && _b !== void 0 ? _b : null;
