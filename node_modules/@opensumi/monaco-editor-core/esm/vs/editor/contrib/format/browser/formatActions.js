...
class FormatDocumentAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/format/browser/formatActions",0, "Format Document"),
...
class FormatSelectionAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/format/browser/formatActions",1, "Format Selection"),
