...
(0, editorExtensions_1.registerEditorAction)(class ShowLensesInCurrentLine extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: (0, nls_1.localize)("vs/editor/contrib/codelens/browser/codelensController",0, "Show CodeLens Commands For Current Line"),
    ...
    async run(accessor, editor) {
        ...
        const item = await quickInputService.pick(items, {
            canPickMany: false,
            placeHolder: (0, nls_1.localize)("vs/editor/contrib/codelens/browser/codelensController",1, "Select a command")
        });
        if (!item) {
            // Nothing picked
            return;
