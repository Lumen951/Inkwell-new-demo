...
require("./linkedEditing.css");
exports.CONTEXT_ONTYPE_RENAME_INPUT_VISIBLE = new contextkey_1.RawContextKey('LinkedEditingInputVisible', false);
const DECORATION_CLASS_NAME = 'linked-editing-decoration';
let LinkedEditingContribution = LinkedEditingContribution_1 = class LinkedEditingContribution extends lifecycle_1.Disposable {
    static get(editor) {
...
class LinkedEditingAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linkedEditing/browser/linkedEditing",0, "Start Linked Editing"),
...
exports.editorLinkedEditingBackground = (0, colorRegistry_1.registerColor)('editor.linkedEditingBackground', { dark: color_1.Color.fromHex('#f00').transparent(0.3), light: color_1.Color.fromHex('#f00').transparent(0.3), hcDark: color_1.Color.fromHex('#f00').transparent(0.3), hcLight: color_1.Color.white }, nls.localize("vs/editor/contrib/linkedEditing/browser/linkedEditing",1, 'Background color when the editor auto renames on type.'));
