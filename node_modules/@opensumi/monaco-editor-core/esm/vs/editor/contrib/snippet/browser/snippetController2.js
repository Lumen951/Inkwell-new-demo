...
const snippetSession_1 = require("./snippetSession");
                ...
                provideCompletionItems: (model, position) => {
                    ...
                    for (let i = 0; i < activeChoice.choice.options.length; i++) {
                        ...
                        suggestions.push({
                            ...
                            command: { id: 'jumpToNextSnippetPlaceholder', title: (0, nls_1.localize)("vs/editor/contrib/snippet/browser/snippetController2",3, 'Go to next placeholder...') }
                        });
                    }
                    return { suggestions };
                }
...
SnippetController2.InSnippetMode = new contextkey_1.RawContextKey('inSnippetMode', false, (0, nls_1.localize)("vs/editor/contrib/snippet/browser/snippetController2",0, "Whether the editor in current in snippet mode"));
SnippetController2.HasNextTabstop = new contextkey_1.RawContextKey('hasNextTabstop', false, (0, nls_1.localize)("vs/editor/contrib/snippet/browser/snippetController2",1, "Whether there is a next tab stop when in snippet mode"));
SnippetController2.HasPrevTabstop = new contextkey_1.RawContextKey('hasPrevTabstop', false, (0, nls_1.localize)("vs/editor/contrib/snippet/browser/snippetController2",2, "Whether there is a previous tab stop when in snippet mode"));
