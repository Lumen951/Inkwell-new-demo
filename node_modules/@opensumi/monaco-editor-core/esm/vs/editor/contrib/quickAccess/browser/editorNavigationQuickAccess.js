    ...
    doProvide(picker, token) {
        ...
        if (editor && this.canProvideWithTextEditor(editor)) {
            ...
            if (codeEditor) {
                ...
                disposables.add((0, functional_1.createSingleCallFunction)(token.onCancellationRequested)(() => { var _a; return (_a = context.restoreViewState) === null || _a === void 0 ? void 0 : _a.call(context); }));
            }
