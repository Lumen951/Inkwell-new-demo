...
class InPlaceReplaceUp extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/inPlaceReplace/browser/inPlaceReplace",0, "Replace with Previous Value"),
...
class InPlaceReplaceDown extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/inPlaceReplace/browser/inPlaceReplace",1, "Replace with Next Value"),
