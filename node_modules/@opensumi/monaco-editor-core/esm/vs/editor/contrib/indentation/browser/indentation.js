...
const indentUtils = require("./indentUtils");
const nls = require("../../../../nls");
const quickInput_1 = require("../../../../platform/quickinput/common/quickInput");
const indentation_1 = require("../../../common/core/indentation");
...
class IndentationToSpacesAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/indentation/browser/indentation",0, "Convert Indentation to Spaces"),
...
class IndentationToTabsAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/indentation/browser/indentation",1, "Convert Indentation to Tabs"),
    ...
    run(accessor, editor) {
        ...
        const picks = [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? nls.localize("vs/editor/contrib/indentation/browser/indentation",2, "Configured Tab Size")
                : n === creationOpts.tabSize
                    ? nls.localize("vs/editor/contrib/indentation/browser/indentation",3, "Default Tab Size")
                    : n === modelOpts.tabSize
                        ? nls.localize("vs/editor/contrib/indentation/browser/indentation",4, "Current Tab Size")
                        : undefined)
        }));
        // auto focus the tabSize set for the current editor
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: nls.localize("vs/editor/contrib/indentation/browser/indentation",5, "Select Tab Size for Current File"), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
class IndentUsingTabs extends ChangeIndentationSizeAction {
    constructor() {
        super(false, false, {
            ...
            label: nls.localize("vs/editor/contrib/indentation/browser/indentation",6, "Indent Using Tabs"),
...
class IndentUsingSpaces extends ChangeIndentationSizeAction {
    constructor() {
        super(true, false, {
            ...
            label: nls.localize("vs/editor/contrib/indentation/browser/indentation",7, "Indent Using Spaces"),
...
class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    constructor() {
        super(true, true, {
            ...
            label: nls.localize("vs/editor/contrib/indentation/browser/indentation",8, "Change Tab Display Size"),
...
class DetectIndentation extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/indentation/browser/indentation",9, "Detect Indentation from Content"),
...
class ReindentLinesAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/indentation/browser/indentation",10, "Reindent Lines"),
...
class ReindentSelectedLinesAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/indentation/browser/indentation",11, "Reindent Selected Lines"),
