    ...
    constructor() {
        super(true, false, {
            ...
            menuOpts: {
                ...
                icon: (0, iconRegistry_1.registerIcon)('marker-navigation-next', codicons_1.Codicon.arrowDown, nls.localize("vs/editor/contrib/gotoError/browser/gotoError",1, 'Icon for goto next marker.')),
                group: 'navigation',
                order: 1
            }
        });
...
NextMarkerAction.LABEL = nls.localize("vs/editor/contrib/gotoError/browser/gotoError",0, "Go to Next Problem (Error, Warning, Info)");
    ...
    constructor() {
        super(false, false, {
            ...
            menuOpts: {
                ...
                icon: (0, iconRegistry_1.registerIcon)('marker-navigation-previous', codicons_1.Codicon.arrowUp, nls.localize("vs/editor/contrib/gotoError/browser/gotoError",3, 'Icon for goto previous marker.')),
                group: 'navigation',
                order: 2
            }
        });
...
PrevMarkerAction.LABEL = nls.localize("vs/editor/contrib/gotoError/browser/gotoError",2, "Go to Previous Problem (Error, Warning, Info)");
class NextMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(true, true, {
            id: 'editor.action.marker.nextInFiles',
            label: nls.localize("vs/editor/contrib/gotoError/browser/gotoError",4, "Go to Next Problem in Files (Error, Warning, Info)"),
            ...
            menuOpts: {
                ...
                title: nls.localize("vs/editor/contrib/gotoError/browser/gotoError",5, "Next &&Problem"),
                group: '6_problem_nav',
                order: 1
            }
        });
...
class PrevMarkerInFilesAction extends MarkerNavigationAction {
    constructor() {
        super(false, true, {
            ...
            label: nls.localize("vs/editor/contrib/gotoError/browser/gotoError",6, "Go to Previous Problem in Files (Error, Warning, Info)"),
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarGoMenu,
                title: nls.localize("vs/editor/contrib/gotoError/browser/gotoError",7, "Previous &&Problem"),
                group: '6_problem_nav',
                order: 2
            }
        });
