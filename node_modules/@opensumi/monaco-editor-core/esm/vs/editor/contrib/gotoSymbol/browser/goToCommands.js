        ...
        const promise = (0, async_1.raceCancellation)(this._getLocationModel(languageFeaturesService, anchor.model, anchor.position, cts.token), cts.token).then(async (references) => {
            ...
            if (referenceCount === 0) {
                ...
                if (!this.configuration.muteMessage) {
                    ...
                    (_j = messageController_1.MessageController.get(editor)) === null || _j === void 0 ? void 0 : _j.showMessage(this._getNoResultFoundMessage(info), position);
                }
            }
...
class DefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getDefinitionsAtPosition)(languageFeaturesService.definitionProvider, model, position, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",1, 'Definitions'));
    }
...
(0, actions_1.registerAction2)((_a = class GoToDefinitionAction extends DefinitionAction {
        constructor() {
            ...
            commands_1.CommandsRegistry.registerCommandAlias('editor.action.goToDeclaration', _a.id);
        }
    },
...
(0, actions_1.registerAction2)((_b = class OpenDefinitionToSideAction extends DefinitionAction {
        constructor() {
            ...
            commands_1.CommandsRegistry.registerCommandAlias('editor.action.openDeclarationToTheSide', _b.id);
        }
    },
...
(0, actions_1.registerAction2)((_c = class PeekDefinitionAction extends DefinitionAction {
        constructor() {
            ...
            commands_1.CommandsRegistry.registerCommandAlias('editor.action.previewDeclaration', _c.id);
        }
    },
...
class DeclarationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getDeclarationsAtPosition)(languageFeaturesService.declarationProvider, model, position, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",5, 'Declarations'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
...
class TypeDefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getTypeDefinitionsAtPosition)(languageFeaturesService.typeDefinitionProvider, model, position, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",11, 'Type Definitions'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
...
class ImplementationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getImplementationsAtPosition)(languageFeaturesService.implementationProvider, model, position, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",15, 'Implementations'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
...
(0, actions_1.registerAction2)(class GoToReferencesAction extends ReferencesAction {
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getReferencesAtPosition)(languageFeaturesService.referenceProvider, model, position, true, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",22, 'References'));
    }
});
(0, actions_1.registerAction2)(class PeekReferencesAction extends ReferencesAction {
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new referencesModel_1.ReferencesModel(await (0, goToSymbol_1.getReferencesAtPosition)(languageFeaturesService.referenceProvider, model, position, false, token), nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",23, 'References'));
    }
});
//#endregion
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return new referencesModel_1.ReferencesModel(this._references, nls.localize("vs/editor/contrib/gotoSymbol/browser/goToCommands",24, 'Locations'));
    }
    _getNoResultFoundMessage(info) {
