...
exports.ctxHasSymbols = new contextkey_1.RawContextKey('hasSymbols', false, (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/symbolNavigation",0, "Whether there are symbol locations that can be navigated via keyboard-only."));
...
let SymbolNavigationService = class SymbolNavigationService {
    ...
    _showMessage() {
        ...
        const message = kb
            ? (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/symbolNavigation",1, "Symbol {0} of {1}, {2} for next", this._currentIdx + 1, this._currentModel.references.length, kb.getLabel())
            : (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/symbolNavigation",2, "Symbol {0} of {1}", this._currentIdx + 1, this._currentModel.references.length);
