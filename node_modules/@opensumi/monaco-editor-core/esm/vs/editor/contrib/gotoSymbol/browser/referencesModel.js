...
class OneReference {
    ...
    get ariaMessage() {
        ...
        if (!preview) {
            return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/referencesModel",0, "in {0} on line {1} at column {2}", (0, resources_1.basename)(this.uri), this.range.startLineNumber, this.range.startColumn);
        }
        else {
            return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/referencesModel",1, "{0} in {1} on line {2} at column {3}", preview.value, (0, resources_1.basename)(this.uri), this.range.startLineNumber, this.range.startColumn);
        }
    }
}
...
class FileReferences {
    ...
    get ariaMessage() {
        ...
        if (len === 1) {
            return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/referencesModel",2, "1 symbol in {0}, full path {1}", (0, resources_1.basename)(this.uri), this.uri.fsPath);
        }
        else {
            return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/referencesModel",3, "{0} symbols in {1}, full path {2}", len, (0, resources_1.basename)(this.uri), this.uri.fsPath);
        }
    }
...
class ReferencesModel {
    ...
    get ariaMessage() {
        if (this.isEmpty) {
            return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/referencesModel",4, "No results found");
        }
        else if (this.references.length === 1) {
            return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/referencesModel",5, "Found 1 symbol in {0}", this.references[0].uri.fsPath);
        }
        else if (this.groups.length === 1) {
            return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/referencesModel",6, "Found {0} symbols in {1}", this.references.length, this.groups[0].uri.fsPath);
        }
        else {
            return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/referencesModel",7, "Found {0} symbols in {1} files", this.references.length, this.groups.length);
        }
    }
