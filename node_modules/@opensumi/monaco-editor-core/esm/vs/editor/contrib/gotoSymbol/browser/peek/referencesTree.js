...
let FileReferencesTemplate = class FileReferencesTemplate extends lifecycle_1.Disposable {
    ...
    set(element, matches) {
        ...
        if (len > 1) {
            this.badge.setTitleFormat((0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/peek/referencesTree",0, "{0} references", len));
        }
        else {
            this.badge.setTitleFormat((0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/peek/referencesTree",1, "{0} reference", len));
        }
    }
};
...
class AccessibilityProvider {
    getWidgetAriaLabel() {
        return (0, nls_1.localize)("vs/editor/contrib/gotoSymbol/browser/peek/referencesTree",2, "References");
    }
