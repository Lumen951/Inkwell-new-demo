...
let ReferenceWidget = class ReferenceWidget extends peekView.PeekViewWidget {
    ...
    _fillBody(containerElement) {
        ...
        this._previewNotAvailableMessage = new textModel_1.TextModel(nls.localize("vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget",0, "no preview available"), modesRegistry_1.PLAINTEXT_LANGUAGE_ID, textModel_1.TextModel.DEFAULT_CREATION_OPTIONS, null, this._undoRedoService, this._languageService, this._languageConfigurationService);
        // tree
