...
let CommonFindController = CommonFindController_1 = class CommonFindController extends lifecycle_1.Disposable {
    get editor() {
        return this._editor;
    }
    static get(editor) {
...
exports.StartFindAction = (0, editorExtensions_1.registerMultiEditorAction)(new editorExtensions_1.MultiEditorAction({
    ...
    label: nls.localize("vs/editor/contrib/find/browser/findController",1, "Find"),
    alias: 'Find',
    ...
    menuOpts: {
        ...
        group: '3_find',
        title: nls.localize("vs/editor/contrib/find/browser/findController",2, "&&Find"),
        order: 1
    }
}));
...
class StartFindWithArgsAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/find/browser/findController",3, "Find With Arguments"),
...
class StartFindWithSelectionAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/find/browser/findController",4, "Find With Selection"),
...
class NextMatchFindAction extends MatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/find/browser/findController",5, "Find Next"),
            alias: 'Find Next',
            precondition: undefined,
            kbOpts: [{
...
class PreviousMatchFindAction extends MatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/find/browser/findController",6, "Find Previous"),
            alias: 'Find Previous',
            precondition: undefined,
            kbOpts: [{
                    kbExpr: editorContextKeys_1.EditorContextKeys.focus,
...
class MoveToMatchFindAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/find/browser/findController",7, "Go to Match..."),
            alias: 'Go to Match...',
    ...
    run(accessor, editor, args) {
        ...
        if (matchesCount < 1) {
            ...
            notificationService.notify({
                ...
                message: nls.localize("vs/editor/contrib/find/browser/findController",8, "No matches. Try searching for something else.")
            });
            return;
        }
        const quickInputService = accessor.get(quickInput_1.IQuickInputService);
        const inputBox = quickInputService.createInputBox();
        inputBox.placeholder = nls.localize("vs/editor/contrib/find/browser/findController",9, "Type a number to go to a specific match (between 1 and {0})", matchesCount);
        ...
        const updatePickerAndEditor = (value) => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = nls.localize("vs/editor/contrib/find/browser/findController",10, "Please type a number between 1 and {0}", controller.getState().matchesCount);
        ...
        inputBox.onDidAccept(() => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = nls.localize("vs/editor/contrib/find/browser/findController",11, "Please type a number between 1 and {0}", controller.getState().matchesCount);
            }
        });
        inputBox.onDidHide(() => {
            this.clearDecorations(editor);
...
class NextSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/find/browser/findController",12, "Find Next Selection"),
...
class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/find/browser/findController",13, "Find Previous Selection"),
...
exports.StartFindReplaceAction = (0, editorExtensions_1.registerMultiEditorAction)(new editorExtensions_1.MultiEditorAction({
    ...
    label: nls.localize("vs/editor/contrib/find/browser/findController",14, "Replace"),
    alias: 'Replace',
    precondition: contextkey_1.ContextKeyExpr.or(editorContextKeys_1.EditorContextKeys.focus, contextkey_1.ContextKeyExpr.has('editorIsOpen')),
    kbOpts: {
        kbExpr: null,
    ...
    menuOpts: {
        menuId: actions_1.MenuId.MenubarEditMenu,
        group: '3_find',
        title: nls.localize("vs/editor/contrib/find/browser/findController",15, "&&Replace"),
        order: 2
    }
}));
