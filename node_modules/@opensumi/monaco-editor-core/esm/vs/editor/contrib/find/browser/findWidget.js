...
const findSelectionIcon = (0, iconRegistry_1.registerIcon)('find-selection', codicons_1.Codicon.selection, nls.localize("vs/editor/contrib/find/browser/findWidget",0, 'Icon for \'Find in Selection\' in the editor find widget.'));
const findCollapsedIcon = (0, iconRegistry_1.registerIcon)('find-collapsed', codicons_1.Codicon.chevronRight, nls.localize("vs/editor/contrib/find/browser/findWidget",1, 'Icon to indicate that the editor find widget is collapsed.'));
const findExpandedIcon = (0, iconRegistry_1.registerIcon)('find-expanded', codicons_1.Codicon.chevronDown, nls.localize("vs/editor/contrib/find/browser/findWidget",2, 'Icon to indicate that the editor find widget is expanded.'));
exports.findReplaceIcon = (0, iconRegistry_1.registerIcon)('find-replace', codicons_1.Codicon.replace, nls.localize("vs/editor/contrib/find/browser/findWidget",3, 'Icon for \'Replace\' in the editor find widget.'));
exports.findReplaceAllIcon = (0, iconRegistry_1.registerIcon)('find-replace-all', codicons_1.Codicon.replaceAll, nls.localize("vs/editor/contrib/find/browser/findWidget",4, 'Icon for \'Replace All\' in the editor find widget.'));
exports.findPreviousMatchIcon = (0, iconRegistry_1.registerIcon)('find-previous-match', codicons_1.Codicon.arrowUp, nls.localize("vs/editor/contrib/find/browser/findWidget",5, 'Icon for \'Find Previous\' in the editor find widget.'));
exports.findNextMatchIcon = (0, iconRegistry_1.registerIcon)('find-next-match', codicons_1.Codicon.arrowDown, nls.localize("vs/editor/contrib/find/browser/findWidget",6, 'Icon for \'Find Next\' in the editor find widget.'));
...
const NLS_MATCHES_COUNT_LIMIT_TITLE = nls.localize("vs/editor/contrib/find/browser/findWidget",19, "Only the first {0} results are highlighted, but all find operations work on the entire text.", findModel_1.MATCHES_LIMIT);
exports.NLS_MATCHES_LOCATION = nls.localize("vs/editor/contrib/find/browser/findWidget",20, "{0} of {1}");
exports.NLS_NO_RESULTS = nls.localize("vs/editor/contrib/find/browser/findWidget",21, "No results");
