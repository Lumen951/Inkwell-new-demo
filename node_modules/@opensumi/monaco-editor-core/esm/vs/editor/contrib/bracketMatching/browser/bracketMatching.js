...
const overviewRulerBracketMatchForeground = (0, colorRegistry_1.registerColor)('editorOverviewRuler.bracketMatchForeground', { dark: '#A0A0A0', light: '#A0A0A0', hcDark: '#A0A0A0', hcLight: '#A0A0A0' }, nls.localize("vs/editor/contrib/bracketMatching/browser/bracketMatching",0, 'Overview ruler marker color for matching brackets.'));
class JumpToBracketAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            id: 'editor.action.jumpToBracket',
            label: nls.localize("vs/editor/contrib/bracketMatching/browser/bracketMatching",1, "Go to Bracket"),
            alias: 'Go to Bracket',
...
class SelectToBracketAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/bracketMatching/browser/bracketMatching",2, "Select to Bracket"),
            alias: 'Select to Bracket',
            precondition: undefined,
            metadata: {
                description: nls.localize2("vs/editor/contrib/bracketMatching/browser/bracketMatching",5, "Select the text inside and including the brackets or curly braces"),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
...
class RemoveBracketsAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/bracketMatching/browser/bracketMatching",3, "Remove Brackets"),
...
actions_1.MenuRegistry.appendMenuItem(actions_1.MenuId.MenubarGoMenu, {
    ...
    command: {
        id: 'editor.action.jumpToBracket',
        title: nls.localize("vs/editor/contrib/bracketMatching/browser/bracketMatching",4, "Go to &&Bracket")
    },
    order: 2
});
