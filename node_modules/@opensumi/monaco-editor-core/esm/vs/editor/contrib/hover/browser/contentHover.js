...
const resizableContentWidget_1 = require("./resizableContentWidget");
...
const settings_1 = require("../../../../base/browser/settings");
const $ = dom.$;
let ContentHoverController = ContentHoverController_1 = class ContentHoverController extends lifecycle_1.Disposable {
...
let ContentHoverWidget = ContentHoverWidget_1 = class ContentHoverWidget extends resizableContentWidget_1.ResizableContentWidget {
    get isColorPickerVisible() {
        var _a;
    ...
    _updateMaxDimensions() {
        const height = Math.max(this._editor.getLayoutInfo().height / 4, settings_1.overflowWidgetsSettings.hoverWidgetMaxHeight, ContentHoverWidget_1._lastDimensions.height);
        const width = Math.max(this._editor.getLayoutInfo().width * 0.66, settings_1.overflowWidgetsSettings.hoverWidgetMaxWidth, ContentHoverWidget_1._lastDimensions.width);
    ...
    showAt(node, hoverData) {
        ...
        const accessibleViewHint = hoverFocused && (0, hoverWidget_1.getHoverAccessibleViewHint)(this._configurationService.getValue('accessibility.verbosity.hover') === true && this._accessibilityService.isScreenReaderOptimized(), (_d = (_c = this._keybindingService.lookupKeybinding('editor.action.accessibleView')) === null || _c === void 0 ? void 0 : _c.getAriaLabel()) !== null && _d !== void 0 ? _d : '');
