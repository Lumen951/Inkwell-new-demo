...
const codeActionController_1 = require("../../codeAction/browser/codeActionController");
const types_1 = require("../../codeAction/common/types");
...
let MarkerHoverParticipant = class MarkerHoverParticipant {
    ...
    renderMarkerStatusbar(context, markerHover, disposables) {
        ...
        if (!this._editor.getOption(91 /* EditorOption.readOnly */)) {
            ...
            const updatePlaceholderDisposable = this.recentMarkerCodeActionsInfo && !this.recentMarkerCodeActionsInfo.hasCodeActions ? lifecycle_1.Disposable.None : (0, async_1.disposableTimeout)(() => quickfixPlaceholderElement.textContent = nls.localize("vs/editor/contrib/hover/browser/markerHoverParticipant",2, "Checking for quick fixes..."), 200, disposables);
