...
exports.warningIcon = (0, iconRegistry_1.registerIcon)('extensions-warning-message', codicons_1.Codicon.warning, nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",0, 'Icon shown with a warning message in the extensions editor.'));
...
class DisableHighlightingInCommentsAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",11, 'Disable highlighting of characters in comments'),
    ...
    async run(accessor, editor, args) {
        const configurationService = accessor === null || accessor === void 0 ? void 0 : accessor.get(configuration_1.IConfigurationService);
...
class DisableHighlightingInStringsAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",13, 'Disable highlighting of characters in strings'),
            alias: 'Disable highlighting of characters in strings',
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",12, 'Disable Highlight In Strings');
    }
    async run(accessor, editor, args) {
        const configurationService = accessor === null || accessor === void 0 ? void 0 : accessor.get(configuration_1.IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfAmbiguousCharactersAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",15, 'Disable highlighting of ambiguous characters'),
            alias: 'Disable highlighting of ambiguous characters',
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",14, 'Disable Ambiguous Highlight');
    }
    async run(accessor, editor, args) {
        const configurationService = accessor === null || accessor === void 0 ? void 0 : accessor.get(configuration_1.IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfInvisibleCharactersAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",17, 'Disable highlighting of invisible characters'),
            alias: 'Disable highlighting of invisible characters',
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",16, 'Disable Invisible Highlight');
    }
    async run(accessor, editor, args) {
        const configurationService = accessor === null || accessor === void 0 ? void 0 : accessor.get(configuration_1.IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfNonBasicAsciiCharactersAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",19, 'Disable highlighting of non basic ASCII characters'),
            alias: 'Disable highlighting of non basic ASCII characters',
            precondition: undefined
        });
        this.shortLabel = nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",18, 'Disable Non ASCII Highlight');
    }
    async run(accessor, editor, args) {
        const configurationService = accessor === null || accessor === void 0 ? void 0 : accessor.get(configuration_1.IConfigurationService);
        if (configurationService) {
...
class ShowExcludeOptions extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",20, "Show Exclude Options"),
    ...
    async run(accessor, editor, args) {
        ...
        function getExcludeCharFromBeingHighlightedLabel(codePoint) {
            if (strings_1.InvisibleCharacters.isInvisibleCharacter(codePoint)) {
                return nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",21, 'Exclude {0} (invisible character) from being highlighted', codePointToHex(codePoint));
            }
            return nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",22, 'Exclude {0} from being highlighted', `${codePointToHex(codePoint)} "${char}"`);
        }
        const options = [];
        if (reason.kind === 0 /* UnicodeHighlighterReasonKind.Ambiguous */) {
            for (const locale of reason.notAmbiguousInLocales) {
                options.push({
                    label: nls.localize("vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter",23, "Allow unicode characters that are more common in the language \"{0}\".", locale),
                    run: async () => {
