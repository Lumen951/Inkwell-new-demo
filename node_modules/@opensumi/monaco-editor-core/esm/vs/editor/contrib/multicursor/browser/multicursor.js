...
const highlightDecorations_1 = require("../../wordHighlighter/browser/highlightDecorations");
...
class InsertCursorAbove extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",2, "Add Cursor Above"),
            ...
            menuOpts: {
                ...
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",3, "&&Add Cursor Above"),
                order: 2
            }
        });
    }
...
class InsertCursorBelow extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",4, "Add Cursor Below"),
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",5, "A&&dd Cursor Below"),
                order: 3
            }
        });
    }
...
class InsertCursorAtEndOfEachLineSelected extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",6, "Add Cursors to Line Ends"),
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",7, "Add C&&ursors to Line Ends"),
                order: 4
            }
        });
    }
...
class InsertCursorAtEndOfLineSelected extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",8, "Add Cursors To Bottom"),
...
class InsertCursorAtTopOfLineSelected extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",9, "Add Cursors To Top"),
...
class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",10, "Add Selection To Next Find Match"),
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",11, "Add &&Next Occurrence"),
                order: 5
            }
        });
    }
...
class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",12, "Add Selection To Previous Find Match"),
            alias: 'Add Selection To Previous Find Match',
            precondition: undefined,
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",13, "Add P&&revious Occurrence"),
                order: 6
            }
        });
    }
...
class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",14, "Move Last Selection To Next Find Match"),
...
class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",15, "Move Last Selection To Previous Find Match"),
...
class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",16, "Select All Occurrences of Find Match"),
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",17, "Select All &&Occurrences"),
                order: 7
            }
        });
    }
...
class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",18, "Change All Occurrences"),
...
let SelectionHighlighter = SelectionHighlighter_1 = class SelectionHighlighter extends lifecycle_1.Disposable {
...
class FocusNextCursor extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",19, "Focus Next Cursor"),
            metadata: {
                description: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",20, "Focuses the next cursor"),
                args: [],
            },
...
class FocusPreviousCursor extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",21, "Focus Previous Cursor"),
            metadata: {
                description: nls.localize("vs/editor/contrib/multicursor/browser/multicursor",22, "Focuses the previous cursor"),
                args: [],
            },
