...
class MoveCaretLeftAction extends MoveCaretAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize("vs/editor/contrib/caretOperations/browser/caretOperations",0, "Move Selected Text Left"),
...
class MoveCaretRightAction extends MoveCaretAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize("vs/editor/contrib/caretOperations/browser/caretOperations",1, "Move Selected Text Right"),
