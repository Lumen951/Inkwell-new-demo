...
class MoveWordCommand extends editorExtensions_1.EditorCommand {
    ...
    runEditorCommand(accessor, editor, args) {
        ...
        const wordSeparators = (0, wordCharacterClassifier_1.getMapForWordSeparators)(editor.getOption(130 /* EditorOption.wordSeparators */));
...
class DeleteInsideWord extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            id: 'deleteInsideWord',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            label: nls.localize("vs/editor/contrib/wordOperations/browser/wordOperations",0, "Delete Word"),
            alias: 'Delete Word'
        });
    }
