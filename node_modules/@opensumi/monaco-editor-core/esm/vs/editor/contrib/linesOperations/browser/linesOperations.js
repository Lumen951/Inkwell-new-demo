...
const trimTrailingWhitespaceCommand_1 = require("../../../common/commands/trimTrailingWhitespaceCommand");
...
const copyLinesCommand_1 = require("./copyLinesCommand");
const moveLinesCommand_1 = require("./moveLinesCommand");
const sortLinesCommand_1 = require("./sortLinesCommand");
...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",0, "Copy Line Up"),
            alias: 'Copy Line Up',
            ...
            menuOpts: {
                ...
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",1, "&&Copy Line Up"),
                order: 1
            }
        });
    }
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",2, "Copy Line Down"),
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",3, "Co&&py Line Down"),
                order: 2
            }
        });
    }
...
class DuplicateSelectionAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",4, "Duplicate Selection"),
            alias: 'Duplicate Selection',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",5, "&&Duplicate Selection"),
                order: 5
            }
        });
    }
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",6, "Move Line Up"),
            alias: 'Move Line Up',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            kbOpts: {
                kbExpr: editorContextKeys_1.EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",7, "Mo&&ve Line Up"),
                order: 3
            }
        });
    }
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",8, "Move Line Down"),
            ...
            menuOpts: {
                menuId: actions_1.MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",9, "Move &&Line Down"),
                order: 4
            }
        });
    }
...
class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",10, "Sort Lines Ascending"),
...
class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",11, "Sort Lines Descending"),
...
class DeleteDuplicateLinesAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",12, "Delete Duplicate Lines"),
...
class TrimTrailingWhitespaceAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",13, "Trim Trailing Whitespace"),
...
class DeleteLinesAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",14, "Delete Line"),
            alias: 'Delete Line',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            kbOpts: {
...
class IndentLinesAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",15, "Indent Line"),
            alias: 'Indent Line',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            kbOpts: {
                kbExpr: editorContextKeys_1.EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",16, "Outdent Line"),
            alias: 'Outdent Line',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            kbOpts: {
                kbExpr: editorContextKeys_1.EditorContextKeys.editorTextFocus,
...
class InsertLineBeforeAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",17, "Insert Line Above"),
...
class InsertLineAfterAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",18, "Insert Line Below"),
...
class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllLeft',
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",19, "Delete All Left"),
...
class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllRight',
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",20, "Delete All Right"),
...
class JoinLinesAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",21, "Join Lines"),
            alias: 'Join Lines',
            precondition: editorContextKeys_1.EditorContextKeys.writable,
            kbOpts: {
                kbExpr: editorContextKeys_1.EditorContextKeys.editorTextFocus,
...
class TransposeAction extends editorExtensions_1.EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",22, "Transpose Characters around the Cursor"),
...
class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",23, "Transform to Uppercase"),
...
class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",24, "Transform to Lowercase"),
...
class TitleCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",25, "Transform to Title Case"),
...
class SnakeCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",26, "Transform to Snake Case"),
...
class CamelCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",27, "Transform to Camel Case"),
...
class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize("vs/editor/contrib/linesOperations/browser/linesOperations",28, 'Transform to Kebab Case'),
