...
export declare class TextModel extends Disposable implements model.ITextModel, IDecorationsTreesHost {
    ...
    private _options;
    private _languageSelectionListener;
    private _isDisposed;
    ...
    constructor(source: string | model.ITextBufferFactory, languageIdOrSelection: string | ILanguageSelection, creationOptions: model.ITextModelCreationOptions, associatedResource: URI | null | undefined, _undoRedoService: IUndoRedoService, _languageService: ILanguageService, _languageConfigurationService: ILanguageConfigurationService);
    dispose(): void;
...
export declare class AttachedViews {
    ...
    attachView(): model.IAttachedView;
    detachView(view: model.IAttachedView): void;
}
/**
 * @internal
 */
