...
class GuidesTextModelPart extends textModelPart_1.TextModelPart {
    ...
    getLinesBracketGuides(startLineNumber, endLineNumber, activePosition, options) {
        ...
        if (activePosition && bracketPairs.length > 0) {
            ...
            activeBracketPairRange = (_a = (0, arraysFind_1.findLast)(bracketsContainingActivePosition, (i) => includeSingleLinePairs || i.range.startLineNumber !== i.range.endLineNumber)) === null || _a === void 0 ? void 0 : _a.range;
        }
