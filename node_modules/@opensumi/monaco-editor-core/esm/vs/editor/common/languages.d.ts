...
import { LanguageFilter } from './languageSelector';
/**
 * @internal
 */
 ...
 * @internal
 */
export declare class LazyTokenizationSupport implements IDisposable, ILazyTokenizationSupport {
    private readonly createSupport;
    private _tokenizationSupport;
    constructor(createSupport: () => Promise<ITokenizationSupport & IDisposable | null>);
    dispose(): void;
    get tokenizationSupport(): Promise<ITokenizationSupport | null>;
}
/**
