...
require("./browser/widget/diffEditor/diffEditor.contribution");
...
require("./contrib/colorPicker/browser/standaloneColorPickerActions");
...
require("./contrib/dropOrPasteInto/browser/copyPasteContribution");
require("./contrib/dropOrPasteInto/browser/dropIntoEditorContribution");
...
require("./contrib/inlineCompletions/browser/inlineCompletions.contribution");
require("./contrib/inlineProgress/browser/inlineProgress");
...
require("./contrib/longLinesHelper/browser/longLinesHelper");
require("./contrib/multicursor/browser/multicursor");
require("./contrib/inlineEdit/browser/inlineEdit.contribution");
require("./contrib/parameterHints/browser/parameterHints");
require("./contrib/rename/browser/rename");
require("./contrib/semanticTokens/browser/documentSemanticTokens");
require("./contrib/semanticTokens/browser/viewportSemanticTokens");
...
require("./contrib/diffEditorBreadcrumbs/browser/contribution");
