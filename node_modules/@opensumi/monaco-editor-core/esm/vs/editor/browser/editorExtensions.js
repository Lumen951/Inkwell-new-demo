...
exports.RedoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            menuId: actions_1.MenuId.MenubarEditMenu,
            group: '1_do',
            title: nls.localize("vs/editor/browser/editorExtensions",2, "&&Redo"),
            order: 2
        }, {
            menuId: actions_1.MenuId.CommandPalette,
            group: '',
...
exports.SelectAllCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_basic',
            title: nls.localize("vs/editor/browser/editorExtensions",4, "&&Select All"),
            order: 1
        }, {
            menuId: actions_1.MenuId.CommandPalette,
            group: '',
            title: nls.localize("vs/editor/browser/editorExtensions",5, "Select All"),
            order: 1
        }]
}));
