...
class Widget {
    ...
    _layoutBoxInViewport(anchor, width, _height, ctx) {
    ...
    _layoutBoxInPage(anchor, width, height, ctx) {
        ...
        const TOP_PADDING = settings_1.overflowWidgetsSettings.topPadding;
        const BOTTOM_PADDING = settings_1.overflowWidgetsSettings.bottomPadding;
