    ...
    async computeDiff(original, modified, options, algorithm) {
        ...
        function toLineRangeMappings(changes) {
            return changes.map((c) => {
                var _a;
                return new rangeMapping_1.DetailedLineRangeMapping(new lineRange_1.LineRange(c[0], c[1]), new lineRange_1.LineRange(c[2], c[3]), (_a = c[4]) === null || _a === void 0 ? void 0 : _a.map((c) => new rangeMapping_1.RangeMapping(new range_1.Range(c[0], c[1], c[2], c[3]), new range_1.Range(c[4], c[5], c[6], c[7]))));
            });
        }
    }
