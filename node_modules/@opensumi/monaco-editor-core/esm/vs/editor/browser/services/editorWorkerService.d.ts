...
import { DiffAlgorithmName, IDiffComputationResult, IEditorWorkerService, IUnicodeHighlightsResult } from '../../common/services/editorWorker';
...
import { ILinesDiffComputerOptions } from '../../common/diff/linesDiffComputer';
...
export declare class EditorWorkerClient extends Disposable implements IEditorWorkerClient {
    ...
    computeDirtyDiff(original: URI, modified: URI, ignoreTrimWhitespace: boolean): Promise<IChange[] | null>;
    computeMoreMinimalEdits(resource: URI, edits: languages.TextEdit[], pretty: boolean): Promise<languages.TextEdit[]>;
    computeHumanReadableDiff(resource: URI, edits: languages.TextEdit[], options: ILinesDiffComputerOptions): Promise<languages.TextEdit[]>;
    computeLinks(resource: URI): Promise<languages.ILink[] | null>;
    computeDefaultDocumentColors(resource: URI): Promise<languages.IColorInformation[] | null>;
