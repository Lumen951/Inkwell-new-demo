...
const rangeMapping_1 = require("../../../../common/diff/rangeMapping");
...
const accessibilitySignalService_1 = require("../../../../../platform/accessibilitySignal/browser/accessibilitySignalService");
...
const accessibleDiffViewerInsertIcon = (0, iconRegistry_1.registerIcon)('diff-review-insert', codicons_1.Codicon.add, (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",0, 'Icon for \'Insert\' in accessible diff viewer.'));
const accessibleDiffViewerRemoveIcon = (0, iconRegistry_1.registerIcon)('diff-review-remove', codicons_1.Codicon.remove, (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",1, 'Icon for \'Remove\' in accessible diff viewer.'));
const accessibleDiffViewerCloseIcon = (0, iconRegistry_1.registerIcon)('diff-review-close', codicons_1.Codicon.close, (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",2, 'Icon for \'Close\' in accessible diff viewer.'));
...
AccessibleDiffViewer._ttPolicy = (0, trustedTypes_1.createTrustedTypesPolicy)('diffReview', { createHTML: value => value });
...
let View = class View extends lifecycle_1.Disposable {
    constructor(_element, _model, _width, _height, _models, _languageService) {
        ...
        this._register((0, observable_1.autorun)(reader => {
            ...
            if (this._model.canClose.read(reader)) {
                this._actionBar.push(new actions_1.Action('diffreview.close', (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",3, "Close"), 'close-diff-review ' + themables_1.ThemeIcon.asClassName(accessibleDiffViewerCloseIcon), true, async () => _model.close()), { label: false, icon: true });
            }
        }));
    ...
    _render(store) {
        ...
        container.setAttribute('aria-label', (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",4, 'Accessible Diff Viewer. Use arrow up and down to navigate.'));
        ...
        for (const viewItem of (group === null || group === void 0 ? void 0 : group.lines) || []) {
            ...
            if (viewItem.type === LineType.Header) {
                ...
                const getAriaLines = (lines) => lines === 0 ? (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",5, "no lines changed")
                    : lines === 1 ? (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",6, "1 line changed")
                        : (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",7, "{0} lines changed", lines);
                ...
                header.setAttribute('aria-label', (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",8, "Difference {0} of {1}: original line {2}, {3}, modified line {4}, {5}", (diffIndex + 1), diffsLength, r.original.startLineNumber, originalChangedLinesCntAria, r.modified.startLineNumber, modifiedChangedLinesCntAria));
    ...
    _createRow(item, lineHeight, width, originalOptions, originalModel, originalModelOpts, modifiedOptions, modifiedModel, modifiedModelOpts) {
        ...
        if (lineContent.length === 0) {
            lineContent = (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",9, "blank");
        }
        let ariaLabel = '';
        switch (item.type) {
            case LineType.Unchanged:
                if (item.originalLineNumber === item.modifiedLineNumber) {
                    ariaLabel = (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",10, "{0} unchanged line {1}", lineContent, item.originalLineNumber);
                }
                else {
                    ariaLabel = (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",11, "{0} original line {1} modified line {2}", lineContent, item.originalLineNumber, item.modifiedLineNumber);
                }
                break;
            case LineType.Added:
                ariaLabel = (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",12, "+ {0} modified line {1}", lineContent, item.modifiedLineNumber);
                break;
            case LineType.Deleted:
                ariaLabel = (0, nls_1.localize)("vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer",13, "- {0} original line {1}", lineContent, item.originalLineNumber);
                break;
        }
