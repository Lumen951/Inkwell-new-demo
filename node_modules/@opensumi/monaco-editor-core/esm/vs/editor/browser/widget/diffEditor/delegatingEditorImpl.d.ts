...
import { IDiffEditorViewModel, IEditor, IEditorAction, IEditorDecorationsCollection, IEditorModel, IEditorViewState, ScrollType } from '../../../common/editorCommon';
...
export declare abstract class DelegatingEditor extends Disposable implements IEditor {
    ...
    readonly onDidDispose: import("../../../../base/common/event").Event<void>;
