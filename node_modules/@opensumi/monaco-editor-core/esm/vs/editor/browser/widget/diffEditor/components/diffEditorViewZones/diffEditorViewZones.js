...
const registrations_contribution_1 = require("../../registrations.contribution");
const diffEditorViewModel_1 = require("../../diffEditorViewModel");
const inlineDiffDeletedCodeMargin_1 = require("./inlineDiffDeletedCodeMargin");
const renderLines_1 = require("./renderLines");
...
let DiffEditorViewZones = class DiffEditorViewZones extends lifecycle_1.Disposable {
    constructor(_targetWindow, _editors, _diffModel, _options, _diffEditorWidget, _canIgnoreViewZoneUpdateEvent, _origViewZonesToIgnore, _modViewZonesToIgnore, _clipboardService, _contextMenuService) {
        ...
        const originalModelTokenizationCompleted = this._diffModel.map(m => m ? (0, observable_1.observableFromEvent)(m.model.original.onDidChangeTokens, () => m.model.original.tokenization.backgroundTokenizationState === 2 /* BackgroundTokenizationState.Completed */) : undefined).map((m, reader) => m === null || m === void 0 ? void 0 : m.read(reader));
