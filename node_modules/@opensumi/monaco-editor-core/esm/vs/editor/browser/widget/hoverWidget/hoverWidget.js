...
let HoverWidget = class HoverWidget extends widget_1.Widget {
    ...
    constructor(options, _keybindingService, _configurationService, _openerService, _instantiationService, _accessibilityService) {
        ...
        if (hideOnHover && ((_h = options.appearance) === null || _h === void 0 ? void 0 : _h.showHoverHint)) {
            ...
            infoElement.textContent = (0, nls_1.localize)("vs/editor/browser/widget/hoverWidget/hoverWidget",0, 'Hold {0} key to mouse over', platform_1.isMacintosh ? 'Option' : 'Alt');
    ...
    render(container) {
        ...
        const accessibleViewHint = hoverFocused && (0, hoverWidget_1.getHoverAccessibleViewHint)(this._configurationService.getValue('accessibility.verbosity.hover') === true && this._accessibilityService.isScreenReaderOptimized(), (_a = this._keybindingService.lookupKeybinding('editor.action.accessibleView')) === null || _a === void 0 ? void 0 : _a.getAriaLabel());
