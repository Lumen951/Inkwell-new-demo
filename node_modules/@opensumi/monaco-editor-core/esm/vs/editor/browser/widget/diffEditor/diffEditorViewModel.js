...
const diffProviderFactoryService_1 = require("./diffProviderFactoryService");
const utils_1 = require("./utils");
const lineRange_1 = require("../../../common/core/lineRange");
const defaultLinesDiffComputer_1 = require("../../../common/diff/defaultLinesDiffComputer/defaultLinesDiffComputer");
const rangeMapping_1 = require("../../../common/diff/rangeMapping");
const beforeEditPositionMapper_1 = require("../../../common/model/bracketPairsTextModelPart/bracketPairsTree/beforeEditPositionMapper");
const combineTextEditInfos_1 = require("../../../common/model/bracketPairsTextModelPart/bracketPairsTree/combineTextEditInfos");
const heuristicSequenceOptimizations_1 = require("../../../common/diff/defaultLinesDiffComputer/heuristicSequenceOptimizations");
...
let DiffEditorViewModel = class DiffEditorViewModel extends lifecycle_1.Disposable {
    ...
    constructor(model, _options, _diffProviderFactoryService) {
        ...
        this.activeMovedText = (0, observable_1.derived)(this, r => { var _a, _b; return (_b = (_a = this.movedTextToCompare.read(r)) !== null && _a !== void 0 ? _a : this._hoveredMovedText.read(r)) !== null && _b !== void 0 ? _b : this._activeMovedText.read(r); });
    ...
    restoreSerializedState(state) {
        var _a;
        const ranges = (_a = state.collapsedRegions) === null || _a === void 0 ? void 0 : _a.map(r => lineRange_1.LineRange.deserialize(r.range));
        const regions = this._unchangedRegions.get();
        if (!regions || !ranges) {
            return;
        }
