...
const tabFocus_1 = require("../config/tabFocus");
...
const codeEditorContributions_1 = require("./codeEditorContributions");
...
let CodeEditorWidget = CodeEditorWidget_1 = class CodeEditorWidget extends lifecycle_1.Disposable {
    //#endregion
    get isSimpleWidget() {
    ...
    constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        for (const action of editorExtensions_1.EditorExtensionsRegistry.getEditorActions()) {
            ...
            const internalAction = new editorAction_1.InternalEditorAction(action.id, action.label, action.alias, action.metadata, (_a = action.precondition) !== null && _a !== void 0 ? _a : undefined, (args) => {
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return cursorWordOperations_1.WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(130 /* EditorOption.wordSeparators */), position);
    }
            ...
            switch (e.kind) {
                ...
                case 6 /* OutgoingViewModelEventKind.CursorStateChanged */: {
                    if (e.reachedMaxCursorCount) {
                        ...
                        const message = nls.localize("vs/editor/browser/widget/codeEditorWidget",0, "The number of cursors has been limited to {0}. Consider using [find and replace](https://code.visualstudio.com/docs/editor/codebasics#_find-and-replace) for larger changes or increase the editor multi cursor limit setting.", multiCursorLimit);
                        this._notificationService.prompt(notification_1.Severity.Warning, message, [
                            ...
                            {
                                label: nls.localize("vs/editor/browser/widget/codeEditorWidget",1, 'Increase Multi Cursor Limit'),
                                run: () => {
...
class CodeEditorWidgetFocusTracker extends lifecycle_1.Disposable {
    ...
    refreshState() {
        ...
        (_b = (_a = this._overflowWidgetsDomNode) === null || _a === void 0 ? void 0 : _a.refreshState) === null || _b === void 0 ? void 0 : _b.call(_a);
    }
}
