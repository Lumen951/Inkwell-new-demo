...
const dompurify_1 = require("../../dompurify/dompurify");
...
class Button extends lifecycle_1.Disposable {
    ...
    set label(value) {
        ...
        if (!this._hover) {
            this._hover = this._register((0, iconLabelHover_1.setupCustomHover)((0, hoverDelegate_1.getDefaultHoverDelegate)('mouse'), this._element, title));
        }
        else {
...
class ButtonWithDropdown extends lifecycle_1.Disposable {
    constructor(container, options) {
        ...
        this._register((0, iconLabelHover_1.setupCustomHover)((0, hoverDelegate_1.getDefaultHoverDelegate)('mouse'), this.dropdownButton.element, (0, nls_1.localize)("vs/base/browser/ui/button/button",0, 'More Actions...')));
