...
class IconLabel extends lifecycle_1.Disposable {
    constructor(container, options) {
        ...
        this.hoverDelegate = (_a = options === null || options === void 0 ? void 0 : options.hoverDelegate) !== null && _a !== void 0 ? _a : (0, hoverDelegate_1.getDefaultHoverDelegate)('mouse');
    }
    get element() {
    ...
    setLabel(label, description, options) {
        ...
        if (description || this.descriptionNode) {
            ...
            if (descriptionNode instanceof highlightedLabel_1.HighlightedLabel) {
                ...
                descriptionNode.textContent = description && (options === null || options === void 0 ? void 0 : options.labelEscapeNewLines) ? highlightedLabel_1.HighlightedLabel.escapeNewLines(description, []) : (description || '');
                this.setupHover(descriptionNode.element, (options === null || options === void 0 ? void 0 : options.descriptionTitle) || '');
