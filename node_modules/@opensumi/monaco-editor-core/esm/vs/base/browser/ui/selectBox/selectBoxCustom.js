...
class SelectBoxList extends lifecycle_1.Disposable {
    constructor(options, selected, contextViewProvider, styles, selectBoxOptions) {
        ...
        this._hover = this._register((0, iconLabelHover_1.setupCustomHover)((0, hoverDelegate_1.getDefaultHoverDelegate)('mouse'), this.selectElement, ''));
    ...
    createSelectList(parent) {
        ...
        this.selectList = new listWidget_1.List('SelectBoxCustom', this.selectDropDownListContainer, this, [this.listRenderer], {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => (0, nls_1.localize)("vs/base/browser/ui/selectBox/selectBoxCustom",0, "Select Box"),
