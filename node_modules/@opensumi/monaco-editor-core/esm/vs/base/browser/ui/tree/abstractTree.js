...
const findInput_1 = require("../findinput/findInput");
...
class ModeToggle extends toggle_1.Toggle {
    constructor(opts) {
        ...
        super({
            ...
            title: (0, nls_1.localize)("vs/base/browser/ui/tree/abstractTree",0, "Filter"),
...
class FuzzyToggle extends toggle_1.Toggle {
    constructor(opts) {
        ...
        super({
            ...
            title: (0, nls_1.localize)("vs/base/browser/ui/tree/abstractTree",1, "Fuzzy Match"),
            isChecked: (_a = opts.isChecked) !== null && _a !== void 0 ? _a : false,
            inputActiveOptionBorder: opts.inputActiveOptionBorder,
            inputActiveOptionForeground: opts.inputActiveOptionForeground,
            inputActiveOptionBackground: opts.inputActiveOptionBackground
...
class FindWidget extends lifecycle_1.Disposable {
    set mode(mode) {
        ...
        this.findInput.inputBox.setPlaceHolder(mode === TreeFindMode.Filter ? (0, nls_1.localize)("vs/base/browser/ui/tree/abstractTree",2, "Type to filter") : (0, nls_1.localize)("vs/base/browser/ui/tree/abstractTree",3, "Type to search"));
    }
    ...
    constructor(container, tree, contextViewProvider, mode, matchType, options) {
        ...
        this.findInput = this._register(new findInput_1.FindInput(this.elements.findInput, contextViewProvider, {
            label: (0, nls_1.localize)("vs/base/browser/ui/tree/abstractTree",4, "Type to search"),
        ...
        const closeAction = this._register(new actions_1.Action('close', (0, nls_1.localize)("vs/base/browser/ui/tree/abstractTree",5, "Close"), 'codicon codicon-close', true, () => this.dispose()));
    ...
    render() {
        ...
        if (this.pattern && noMatches) {
            if ((_a = this.tree.options.showNotFoundMessage) !== null && _a !== void 0 ? _a : true) {
                (_b = this.widget) === null || _b === void 0 ? void 0 : _b.showMessage({ type: 2 /* MessageType.WARNING */, content: (0, nls_1.localize)("vs/base/browser/ui/tree/abstractTree",6, "No elements found.") });
            }
            else {
...
class StickyScrollWidget {
    ...
    get count() {
        var _a, _b;
        return (_b = (_a = this._previousState) === null || _a === void 0 ? void 0 : _a.count) !== null && _b !== void 0 ? _b : 0;
    }
    getNode(node) {
        var _a;
        return (_a = this._previousState) === null || _a === void 0 ? void 0 : _a.stickyNodes.find(stickyNode => stickyNode.node === node);
    }
    setState(state) {
...
class AbstractTree {
    ...
    get onContextMenu() { var _a, _b; return event_2.Event.any(event_2.Event.filter(event_2.Event.map(this.view.onContextMenu, asTreeContextMenuEvent), e => !e.isStickyScroll), (_b = (_a = this.stickyScrollController) === null || _a === void 0 ? void 0 : _a.onContextMenu) !== null && _b !== void 0 ? _b : event_2.Event.None); }
    ...
    style(styles) {
        ...
        const focusAndSelectionOutline = (0, dom_1.asCssValueWithDefault)(styles.listFocusAndSelectionOutline, (0, dom_1.asCssValueWithDefault)(styles.listSelectionOutline, (_a = styles.listFocusOutline) !== null && _a !== void 0 ? _a : ''));
    ...
    getStickyScrollFocus() {
        var _a;
        const focus = (_a = this.stickyScrollController) === null || _a === void 0 ? void 0 : _a.getFocus();
        return focus !== undefined ? [focus] : [];
    }
    getFocusedPart() {
        var _a;
        return ((_a = this.stickyScrollController) === null || _a === void 0 ? void 0 : _a.focusedLast()) ? 1 /* AbstractTreePart.StickyScroll */ : 0 /* AbstractTreePart.Tree */;
    }
    ...
    getRelativeTop(location) {
        ...
        const stickyScrollNode = (_a = this.stickyScrollController) === null || _a === void 0 ? void 0 : _a.getNode(this.getNode(location));
        return this.view.getRelativeTop(index, (_b = stickyScrollNode === null || stickyScrollNode === void 0 ? void 0 : stickyScrollNode.position) !== null && _b !== void 0 ? _b : (_c = this.stickyScrollController) === null || _c === void 0 ? void 0 : _c.height);
    }
