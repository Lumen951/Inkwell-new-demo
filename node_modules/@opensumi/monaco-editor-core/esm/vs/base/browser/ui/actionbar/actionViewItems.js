...
class BaseActionViewItem extends lifecycle_1.Disposable {
    ...
    updateTooltip() {
        ...
        if ((_b = this.options.hoverDelegate) === null || _b === void 0 ? void 0 : _b.showNativeHover) {
            ...
            if (!this.customHover) {
                const hoverDelegate = (_c = this.options.hoverDelegate) !== null && _c !== void 0 ? _c : (0, hoverDelegate_1.getDefaultHoverDelegate)('element');
                this.customHover = (0, iconLabelHover_1.setupCustomHover)(hoverDelegate, this.element, title);
