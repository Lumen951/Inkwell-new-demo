    ...
    render(container) {
        ...
        const labelRenderer = (el) => {
            ...
            if (this._action.label) {
                this._register((0, iconLabelHover_1.setupCustomHover)((0, hoverDelegate_1.getDefaultHoverDelegate)('mouse'), this.element, this._action.label));
            }
...
class ActionWithDropdownActionViewItem extends actionViewItems_1.ActionViewItem {
    ...
    render(container) {
        ...
        if (this.element) {
            ...
            this.dropdownMenuActionViewItem = this._register(new DropdownMenuActionViewItem(this._register(new actions_1.Action('dropdownAction', nls.localize("vs/base/browser/ui/dropdown/dropdownActionViewItem",0, "More Actions..."))), menuActionsProvider, this.contextMenuProvider, { classNames: ['dropdown', ...themables_1.ThemeIcon.asClassNameArray(codicons_1.Codicon.dropDownButton), ...menuActionClassNames], hoverDelegate: this.options.hoverDelegate }));
