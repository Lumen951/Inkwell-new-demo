...
export declare function findLast<T>(array: readonly T[], predicate: (item: T) => boolean, fromIdx?: number): T | undefined;
...
*/
export declare function findFirstMaxBy<T>(array: readonly T[], comparator: Comparator<T>): T | undefined;
/**
 * Returns the last item that is equal to or greater than every other item.
*/
export declare function findLastMaxBy<T>(array: readonly T[], comparator: Comparator<T>): T | undefined;
/**
 * Returns the first item that is equal to or less than every other item.
*/
export declare function findFirstMinBy<T>(array: readonly T[], comparator: Comparator<T>): T | undefined;
export declare function findMaxIdxBy<T>(array: readonly T[], comparator: Comparator<T>): number;
/**
