...
function derivedOpts(options, computeFn) {
    var _a;
    return new Derived(new debugName_1.DebugNameData(options.owner, options.debugName, options.debugReferenceFn), computeFn, undefined, undefined, options.onLastObserverRemoved, (_a = options.equalityComparer) !== null && _a !== void 0 ? _a : exports.defaultEqualityComparer);
}
...
function derivedHandleChanges(options, computeFn) {
    var _a;
    return new Derived(new debugName_1.DebugNameData(options.owner, options.debugName, undefined), computeFn, options.createEmptyChangeSummary, options.handleChange, undefined, (_a = options.equalityComparer) !== null && _a !== void 0 ? _a : exports.defaultEqualityComparer);
}
...
class Derived extends base_1.BaseObservable {
    ...
    constructor(_debugNameData, _computeFn, createChangeSummary, _handleChange, _handleLastObserverRemoved = undefined, _equalityComparator) {
        ...
        (_b = (0, logging_1.getLogger)()) === null || _b === void 0 ? void 0 : _b.handleDerivedCreated(this);
    }
    ...
    _recomputeIfNeeded() {
        ...
        (_b = (0, logging_1.getLogger)()) === null || _b === void 0 ? void 0 : _b.handleDerivedRecomputed(this, {
            oldValue,
            newValue: this.value,
            change: undefined,
            didChange,
